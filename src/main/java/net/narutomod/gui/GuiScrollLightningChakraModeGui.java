...
public class GuiScrollLightningChakraModeGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 17;

	public GuiScrollLightningChakraModeGui(ElementsNarutomodMod instance) {
		super(instance, 468);
	}
