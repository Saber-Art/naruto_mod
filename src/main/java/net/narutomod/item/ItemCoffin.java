...
public class ItemCoffin extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:coffinbody")
	public static final Item body = null;
	public ItemCoffin(ElementsNarutomodMod instance) {
		super(instance, 881);
	}

	@Override
	public void initElements() {
		ItemArmor.ArmorMaterial enuma = EnumHelper.addArmorMaterial("COFFIN", "narutomod:sasuke_", 25, new int[]{2, 5, 6, 2}, 9,
				(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("")), 0f);
		elements.items.add(() -> {
			return ((Item)(new Base(enuma) {
			}).setUnlocalizedName("coffinbody").setRegistryName("coffinbody")).setCreativeTab(TabModTab.tab);
		});
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(body, 0, new ModelResourceLocation("narutomod:coffinbody", "inventory"));
	}
