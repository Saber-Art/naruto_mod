...
public class ItemCoffinOpen extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:coffin_openbody")
	public static final Item body = null;
	public ItemCoffinOpen(ElementsNarutomodMod instance) {
		super(instance, 882);
	}

	@Override
	public void initElements() {
		ItemArmor.ArmorMaterial enuma = EnumHelper.addArmorMaterial("COFFIN_OPEN", "narutomod:sasuke_", 25, new int[]{2, 5, 6, 2}, 9,
				(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("")), 0f);

		elements.items.add(() -> {
			return ((Item)(new Base(enuma) {
			}).setUnlocalizedName("coffin_openbody").setRegistryName("coffin_openbody")).setCreativeTab(TabModTab.tab);
		});
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(body, 0, new ModelResourceLocation("narutomod:coffin_openbody", "inventory"));
	}

	public class Base extends ItemArmor implements ItemOnBody.Interface {

		@SideOnly(Side.CLIENT)
		private ModelBiped armorModel;

		public Base (ItemArmor.ArmorMaterial material) { super(material, 0, EntityEquipmentSlot.CHEST);}
		...
		public ModelBiped getArmorModel(EntityLivingBase living, ItemStack stack, EntityEquipmentSlot slot, ModelBiped defaultModel) {
			...
			this.armorModel.bipedBody.isHidden = true;
			this.armorModel.bipedHead.isHidden = true;
			this.armorModel.bipedLeftLeg.isHidden = true;
			this.armorModel.bipedLeftArm.isHidden = true;
			this.armorModel.bipedRightArm.isHidden = true;
			this.armorModel.bipedRightLeg.isHidden = true;
		...
		@Override
		public boolean showSkinLayer() { return false; }
		@Override
		public ItemOnBody.BodyPart showOnBody() {
			return ItemOnBody.BodyPart.TORSO;
		}
