...
public class EntityWoodDragon extends ElementsNarutomodMod.ModElement {
	public static final int ENTITYID = 432;
	public static final int ENTITYID_RANGED = 433;
	public EntityWoodDragon(ElementsNarutomodMod instance) {
		super(instance, 864);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EC.class)
				.id(new ResourceLocation("narutomod", "wood_dragon"), ENTITYID).name("wood_dragon").tracker(64, 1, true).build());
	}
	...
	public static class EC extends EntityScalableProjectile.Base {
		...
		public EC(EntityLivingBase shooter, float power) {
			super(shooter);
			this.setOGSize(1.0F, 1.0F);
			this.setEntityScale(power * (1.2F));
		...
		private void setWaitPosition() {
			if (this.shootVec != null) {
				...
				Vec3d vec = this.shootingEntity instanceof EntityLiving && ((EntityLiving)this.shootingEntity).getAttackTarget() != null
						...
						: ProcedureUtils.objectEntityLookingAt(this.shootingEntity, 200d).hitVec.subtract(this.getPositionVector());
...
//System.out.println(s+", partRot:"+this.partRot);
		...
		public void renderParticles() {
			if (this.world instanceof WorldServer) {
				if (this.isLaunched()) {
					...
					if (this.ticksExisted <= 20 && Math.random() < 0.5f) {
		...
		protected void onImpact(RayTraceResult result) {
			...
			if (!this.world.isRemote) {
				...
				this.world.newExplosion(this.shootingEntity, this.posX, this.posY, this.posZ, 5.0F * (size * 2), false,
				...
				ProcedureAoeCommand.set(this, 0.0D, 3.0D).exclude(this.shootingEntity)
						.damageEntities(ItemJutsu.causeJutsuDamage(this, this.shootingEntity), 30f * size);
				...
				//}
				//ew net.narutomod.event.EventSetBlocks(this.world, map, 0, 10, false, false);
				this.setDead();
			}
		}
		...
		public static class Jutsu implements ItemJutsu.IJutsuCallback {
			...
			public void createJutsu(EntityLivingBase entity, float power) {
				entity.world.playSound(null, entity.posX, entity.posY, entity.posZ,
						SoundEvent.REGISTRY.getObject(new ResourceLocation(("narutomod:wood-dragon"))),
	...
	public static class Renderer extends EntityRendererRegister {
		...
		public void register() {
			RenderingRegistry.registerEntityRenderingHandler(EC.class, renderManager -> new Renderer.RenderDragon(renderManager));
		}

		@SideOnly(Side.CLIENT)
		public class RenderDragon extends Render<EC> {
			private final ResourceLocation texture = new ResourceLocation("narutomod:textures/dragon_wood.png");
			private final ResourceLocation texture2 = new ResourceLocation("narutomod:textures/gas256.png");
			private final Renderer.ModelDragonHead model = new Renderer.ModelDragonHead();
